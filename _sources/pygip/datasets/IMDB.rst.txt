...
Implementation for the IMDB dataset.

A binary graph dataset representing movie-related networks, containing graph structures for analysis of cinematic relationships.
...
.. py:method:: load_dgl_data()
    Load IMDB dataset using DGL's GINDataset loader. Extracts and batches the first 16 graphs
...
.. py:attribute:: graph
    :type: dgl.DGLGraph
    The batched graph data structure containing multiple IMDB network graphs.
