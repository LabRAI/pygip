...
``earthformer`` is the canonical PyHazards promotion of the wildfire benchmark Track-O baseline.
...
- Source implementation lineage: ``pyhazards.pipelines.wildfire_benchmark.models.earthformer_track_o``.
