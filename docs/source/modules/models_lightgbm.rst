...
``lightgbm`` is the canonical PyHazards promotion of the wildfire benchmark Track-O baseline.
...
- Source implementation lineage: ``pyhazards.pipelines.wildfire_benchmark.models.lightgbm_track_o``.
