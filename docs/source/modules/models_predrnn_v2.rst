...
``predrnn_v2`` is the canonical PyHazards promotion of the wildfire benchmark Track-O baseline.
...
- Source implementation lineage: ``pyhazards.pipelines.wildfire_benchmark.models.predrnn_v2_track_o``.
