...
Implementation for the Political Blogs network dataset.

A network of hyperlinks between political blogs, classified as liberal or conservative.
...
.. py:method:: load_dgl_data()
    ...
    Load Political Blogs dataset using DGL. Creates a graph from edge indices,
...
.. py:method:: load_tg_data()
    ...
    Load Political Blogs dataset using PyTorch Geometric (PyG) loader.
...
.. py:attribute:: dataset
    :type: torch_geometric.datasets.PolBlogs
